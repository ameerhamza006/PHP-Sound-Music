            ...
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <div class="slider_container slider_music col-sm-5 col-md-4 col-lg-4">
                     ...
                     <input type="range" min="1" max="100" value="0" class="seek_slider" onchange="seekTo1()">
                     <div class="total-duration">50:00</div>
                  </div>
                  <div class="buttons col-6  col-sm-3 col-md-2  col-lg-2">
                     <div class="prev-track" onclick="prevTrack1()"><i class="fa fa-step-backward fa-2x"></i></div>
                     <div class="playpause-track" onclick="playpauseTrack1()"><i class="fa fa-play-circle fa-3x"></i></div>
                     <div class="next-track" onclick="nextTrack1()"><i class="fa fa-step-forward fa-2x"></i></div>
                  </div>
                  <div class="slider_container sound col-sm-6 col-md-2  col-lg-2">
                     <i class="fa fa-volume-down"></i>
                     <input type="range" min="1" max="100" value="99" class="volume_slider" onchange="setVolume1()">
