<?php
require 'header.php'; $page = "List-Audio";
error_reporting(0);
if($_GET['Delete-Audio']){
	$g_id = $_GET['Delete-Audio'];
	$delete = "DELETE FROM audio where id='$g_id'";
	$delete_query = mysqli_query($connect,$delete);
	echo "<script>window.location.href='List-Music-Audio.php';</script>";
...
$adselect = "select * from audio where id='$get_id'";
                     ...
                     <div class="iq-card">
                        ...
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Update Music Audio</h4>
                           </div>
                        ...
                        <div class="iq-card-body">
                           ...
                           <form class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
                              ...
                              <button class="btn btn-primary" name="uabtn" type="submit">Update Music</button>
                           </form>
                        </div>
                     </div>
...
<?php
	...
	#for album get all value 	
$adselect = "select * from audio where id='$get_idi'";
$adrun = mysqli_query($connect,$adselect);
	$row = mysqli_fetch_array($adrun);
	$img_id = $row['0'];
	$img_title = $row['1'];
...
?>
 ...
 <div class="col-sm-12 col-lg-12">
                     <div class="iq-card">
						 <?php Update_Audio_image(); ?>
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Update Music Audio Image</h4>
                           </div>
                           <div class="iq-card-header-toolbar d-flex align-items-center">
                           <a href="List-Music-Audio.php" class="btn btn-primary">List Music</a>
                        </div>
                        ...
                        <div class="iq-card-body">
                           ...
                           <form class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
							...
							<div class="custom-file">
                              ...
                              <button class="btn btn-primary" name="ubtn" type="submit">Update Music</button>
                           </form>
                        </div>
                     </div>
                     ...
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <form class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
							...
							<div class="custom-file">
                                 <input name="aaudio" type="file" class="custom-file-input" id="customFile validationCustom05"  required>
                              ...
                              <button class="btn btn-primary" name="audbtn" type="submit">Update Music</button>
                           </form>
                        </div>
                     </div>
