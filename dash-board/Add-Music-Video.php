<?php
require 'header.php'; $page = "Add-video";
                           ...
                           <form class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
							...
							<div class="custom-file">
								...
								<div class="invalid-feedback">
								   ...
								   <div class="col-md-6 mb-3">
                                    <label for="validationCustom05">Choose Video</label>
							<div class="custom-file">
                                 <input name="video" type="file" class="custom-file-input" id="customFile validationCustom05"  required>
                              ...
                              <button class="btn btn-primary" name="vbtn" type="submit">Add Music</button>
                           </form>
                        </div>
                     </div>
